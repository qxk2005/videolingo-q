...
- **⚡ 官方字幕极速通道**：支持在视频下载时，智能识别并下载 YouTube 官方或自动生成的英文字幕，自动进行时间戳对齐与应用，**完全绕过 WhisperX 语音识别**，极大提升极速转写体验。
...
### 2. 灵活的执行路径
- **YouTube 官方字幕通道 (Subtitle Bypass)**：
  如果输入链接中已包含官方或自动生成的英文字幕，无论是在下载视频时还是单独下载字幕，系统都能**智能检测并一键应用**。该模式可**直接跳过**音频分离和 WhisperX ASR 转写阶段，直接进入语义分拆与后续翻译流，将耗时从数分钟缩减至数秒。
